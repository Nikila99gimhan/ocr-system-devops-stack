...
helm.sh/chart: {{ include "model-service.chart" . }}
{{ include "model-service.selectorLabels" . }}
{{- if .Chart.AppVersion }}
...
{{- default (include "model-service.fullname" .) .Values.serviceAccount.name }}
{{- else }}
